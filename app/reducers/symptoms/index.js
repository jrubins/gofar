...
const initialSymptomData = [
  {
    ...
    points: 15,
    helpText: 'Moderate = able to live independently with disabilities which may include hemiplegia, seizures, ' +
  ...
  },
  {
    ...
    label: 'Major trauma',
    points: 10,
    helpText: 'Evidence of multisystem injury or single-system injury associated with shock or altered mental ' +
  ...
  },
  {
    ...
    label: 'Pneumonia',
    points: 1,
    helpText: 'Documented diagnosis of active pneumonia, in which antibiotic therapy has not yet been ' +
  ...
  },
  {
    ...
    label: 'Septicemia',
    points: 7,
    helpText: 'Documented bloodstream infection in which anti-biotic therapy has not yet been ' +
      'started or is still ongoing',
    selected: false,
  },
  {
  ...
  },
  {
    ...
    label: 'Acute stroke',
    points: 8,
    helpText: 'Documented diagnosis of an intracranial or intra-ventricular hemorrhage or ' +
  ...
  },
  {
    ...
    points: 6,
    helpText: 'Evidence of hepatic insufficiency within 24 h of the event, defined by total ' +
  ...
  },
  {
    ...
    points: 4,
    helpText: 'Requiring ongoing dialysis or extracorporeal filtration therapies, or serum ' +
